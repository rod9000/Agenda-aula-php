...
<html>
    ...
    <body>
        ...
        <div align="center">
            <?php
                ...
                while($letras = mysqli_fetch_array($letra)){
                    ...
                    echo "<a href='procura2.php?inicial=$inicial'><button type='submit' class='btn btn-primary' value='".$inicial."' name='letra' ><b>".$inicial."</b></button>|</a>";
                }
                mysqli_close($conn);
            ?>
        </div>
        ...
        <?php
            ...
            $nome2 = $_GET['inicial'];
            $sql = mysqli_query($conn, "SELECT * FROM pessoa WHERE nome LIKE '".$nome2."%'");
